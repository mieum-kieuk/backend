...
////     *
////     */
////    public Long saveQnA(AddProductInquiryForm form, Member member) throws IOException {
////        //Product 엔티티 조회
////        Product product = form.getProductId() != null ? productRepository.findById(form.getProductId())
////                .orElseThrow(() -> new NotFoundException("존재하지 않는 상품입니다.")) : null;
////
////        //BoardImage 엔티티 생성
...
////     * Qna 목록 조회
////     */
////    public Page<ProductInquiryDto> getQnas(Pageable pageable) {
////        return qnaRepository.findAll(pageable).map(ProductInquiryDto::new);
////    }
//
//
//    /**
...
////     * @throws NoSuchBoardException
////     */
////    public EditProductInquiryForm getEditQnaForm(Long qnaId) {
////        Qna qna = qnaRepository.findById(qnaId).orElseThrow(() -> new NoSuchBoardException("존재하지 않는 Q&A 입니다."));
////
////        return new EditProductInquiryForm(qna);
////    }
//
////    /**
////     * Qna 삭제
...
////     */
////    private List<BoardImage> createBoardImages(AddProductInquiryForm form) throws IOException {
