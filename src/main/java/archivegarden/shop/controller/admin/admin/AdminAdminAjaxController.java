...
public class AdminAdminAjaxController {
    ...
    @Operation(
            ...
            description = "입력된 로그인 아이디의 사용 가능 여부를 확인합니다.",
            responses = {
    ...
    @Operation(
            summary = "이메일 중복 검사",
            description = "입력된 이메일 주소의 사용 가능 여부를 확인합니다.",
            responses = {
    ...
    @Operation(
            summary = "관리자 삭제",
            description = "지정된 관리자 계정을 삭제합니다. 해당 ID의 관리자가 존재하지 않으면 오류를 반환합니다.",
            responses = {
    ...
    @Operation(
            summary = "관리자 권한 부여",
            description = "지정된 관리자에게 관리 권한을 부여하고 권한 부여 완료 이메일을 전송합니다.",
            responses = {
