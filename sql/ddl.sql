...
CREATE TABLE REVIEW
(
    REVIEW_ID   BIGINT UNSIGNED GENERATED BY DEFAULT AS IDENTITY,
    MEMBER_ID   BIGINT UNSIGNED NOT NULL,
...
ALTER TABLE REVIEW
    ADD CONSTRAINT FK_REVIEW_MEMBER_ID
        FOREIGN KEY (MEMBER_ID)
            REFERENCES MEMBER (MEMBER_ID);
...
(
    REVIEW_IMAGE_ID   BIGINT UNSIGNED GENERATED BY DEFAULT AS IDENTITY,
...
ALTER TABLE REVIEW_IMAGE
    ADD CONSTRAINT FK_REVIEW_IMAGE_REVIEW_ID
...
ALTER TABLE NOTICE
    ADD CONSTRAINT FK_NOTICE_MEMBER_ID
        FOREIGN KEY (MEMBER_ID)
            REFERENCES MEMBER (MEMBER_ID)